        ...
        <div className="h-[100vh] flex flex-col items-center">
            ...
            <div className="bg-yellow-400 m-5 p-2">
                ...
                <div className="flex justify-evenly">
                    <Link href='company/A運送' className="bg-gray-200 m-2 p-1">A運送</Link>
                    <Link href='company/B食品' className="bg-gray-200 m-2 p-1">B食品</Link>
                    <Link href='company/架空建設' className="bg-gray-200 m-2 p-1">架空建設</Link>
                </div>
            </div>
            <Tokuikensaku />
        </div>

        ...
        <div className="h-[100vh] flex flex-col items-center">
            ...
            <div className="bg-yellow-400 m-5 p-2">
                ...
                <div className="flex justify-evenly">
                    <Link href='company' className="bg-gray-200 m-2 p-1">会社A</Link>
                    <Link href='company' className="bg-gray-200 m-2 p-1">会社B</Link>
                    <Link href='company' className="bg-gray-200 m-2 p-1">会社C</Link>
                </div>
            </div>
            <Tokuikensaku />
        </div>
